# Discograph UI Style Guide

## 1. Introduction

This document provides guidelines for maintaining visual consistency across the Discograph application. The application
...
Maintain custom variables in `discograph.scss`:
