"""
This module provides a development entry point for the Discograph application using FastAPI.
...
The `create_app` function in `discograph.app.fastapi_app` is used to create the
...
if __name__ == "__main__":
    ...
    requests and serves the Discograph application.
    """
