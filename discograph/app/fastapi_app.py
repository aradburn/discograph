"""
This module defines the FastAPI application for Discograph.
...
The module uses the following components:
    ...
    - discograph.config: For application configuration
    - discograph.exceptions: For custom exception handling
    - discograph.library.cache.cache_manager: For caching
    - discograph.logging_config: For logging configuration
...
def create_app(config: Configuration) -> FastAPI:
    ...
    """
    from discograph.app.fastapi_api import router as api_router
    from discograph.app.fastapi_ui import router as ui_router
    from discograph.app.fastapi_assets import create_assets_router

    # Create a new FastAPI app
    app = FastAPI(
        title="Discograph",
        description="Discograph API for exploring music relationships",
        version="1.0.0",
        lifespan=lifespan,
    )
