"""
This module defines the API endpoints for the Discograph application using FastAPI.
...
`discograph.middleware` for rate limiting. `RoleCache` is used for retrieving
role information.
"""
...
from discograph.app.fastapi_dependencies import rate_limiter
