...
# class SqliteRelationGrapher(RelationGrapher):
#     # __slots__ = (
#     #     "_should_break_loop",
#     #     "_center_entity",
#     #     "_degree",
...
#     ):
#         assert isinstance(center_entity, SqliteEntityDB)
#         super(SqliteRelationGrapher, self).__init__(
...
#             found = SqliteRelationDB.search_bimulti(
#                 session,
#                 lh_entities,
#                 rh_entities,
...
#             found = SqliteEntityDB.search_multi(session, entity_key_slice)
