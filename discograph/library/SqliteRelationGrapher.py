...
class SqliteRelationGrapher(object):
    ...
    def _page_at_winning_distance(self, pages, trellis_nodes_by_distance, winning_distance):
    ...
    def _page_by_distance(self, pages, trellis_nodes_by_distance):
    ...
    def _find_trellis_distance(self, trellis_nodes_by_distance, threshold, verbose=True):
        if verbose:
