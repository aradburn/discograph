...
class Test(discograph.DiscographSqliteTestCase):
    ...
    def test_01(self):
        ...
        release_document = discograph.SqliteRelease.from_element(release_element)
        release_document.resolve_references({}, spuriously=True)
        actual = discograph.SqliteRelation.from_release(release_document)
        expected = [
            {
                'entity_one_id': 41,
                'entity_one_type': discograph.SqliteRelation.EntityType.ARTIST,
                'entity_two_id': -1,
                'entity_two_type': discograph.SqliteRelation.EntityType.LABEL,
                'release_id': 157,
                'role': 'Released On',
                'year': 1994,
            },
            {
                ...
                'entity_one_type': discograph.SqliteRelation.EntityType.ARTIST,
                'entity_two_id': 41,
                'entity_two_type': discograph.SqliteRelation.EntityType.ARTIST,
                'release_id': 157,
                'role': 'Producer',
                'year': 1994
            },
