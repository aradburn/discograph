...
#     ):
#         assert isinstance(center_entity, CockroachEntityDB)
...
#             found = CockroachRelationDB.search_bimulti(
#                 session,
#                 lh_entities,
#                 rh_entities,
...
#             found = CockroachEntityDB.search_multi(session, entity_key_slice)
...
#                 )
#                 relations.update(
#                     CockroachRelationDB.search_multi(
#                         session,
#                         key_slice,
