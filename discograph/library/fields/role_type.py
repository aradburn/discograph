...
class RoleType:
    ...
    role_definitions = collections.OrderedDict(
        # TODO sort out duplicates and ontology hierarchy
        [
            ...
            (
                "Body Percussion",
                (Category.INSTRUMENTS, Subcategory.DRUMS_AND_PERCUSSION),
            ),
            ...
            (
                "Acoustic Guitar",
                (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS),
            ),
            ...
            (
                "Baritone Saxophone",
                (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS),
            ),
            ...
            ("6-String Bass", (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS)),
            (
            ...
            ("Adungu", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Alto Flute", (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS)),
            ("Atabal", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Author", (Category.WRITING_AND_ARRANGEMENT,)),
            ("Authoring", (Category.WRITING_AND_ARRANGEMENT,)),
            ("Automatic Orchestra", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Bandola", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Bandolin", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Bandora", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Banjolin", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Baritone Clarinet", (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS)),
            ("Baritone Horn", (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS)),
            (
                "Baroque Guitar",
                (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS),
            ),
            ("Baryton", (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS)),
            ("Bass-Baritone Vocals", (Category.VOCAL,)),
            ("Bass Flute", (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS)),
            ("Basso Continuo", (Category.VOCAL,)),
            ("Bass Recorder", (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS)),
            ("Bass Trombone", (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS)),
            ("Bass Trumpet", (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS)),
            ("Bass Viol", (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS)),
            ("Bass Violin", (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS)),
            ("Bawu", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Beats", (Category.INSTRUMENTS, Subcategory.DRUMS_AND_PERCUSSION)),
            ("Bolivian Flute", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Bolon", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Booklet Editor", (Category.VISUAL,)),
            ("Buzuq", (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS)),
            ("Caja Vallenata", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Calligraphy", (Category.VISUAL,)),
            ("Camera Operator", (Category.TECHNICAL,)),
            ("Carnyx", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Cello Banjo", (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS)),
            ("Chácaras", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Changi", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Chonguri", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Chuniri", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            (
                "Cigar Box Guitar",
                (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS),
            ),
            ("Citole", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Clap Sticks", (Category.INSTRUMENTS, Subcategory.DRUMS_AND_PERCUSSION)),
            ("Clàrsach", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Claviorgan", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            (
                "C Melody Saxophone",
                (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS),
            ),
            ("Collected By", (Category.PRODUCTION,)),
            ("Comb", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Commentator", (Category.PRODUCTION,)),
            ("Consultant", (Category.PRODUCTION,)),
            (
                "Contrabass Trombone",
                (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS),
            ),
            ("Costume Designer", (Category.VISUAL,)),
            ("Created By", (Category.PRODUCTION,)),
            ("Cromorne", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Cura", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Danso", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Deaejeng", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Dialog", (Category.PRODUCTION,)),
            ("Diddley Bow", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Directed", (Category.PRODUCTION,)),
            ("Direct Metal Mastering By", (Category.TECHNICAL,)),
            ("Dobro", (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS)),
            ("Doira", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Doli", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Dombra", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Editor", (Category.PRODUCTION,)),
            (
                "Electric Cello",
                (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS),
            ),
            ("Electric Harmonium", (Category.INSTRUMENTS, Subcategory.KEYBOARD)),
            (
                "Electric Harpsichord",
                (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS),
            ),
            ("Electric Organ", (Category.INSTRUMENTS, Subcategory.KEYBOARD)),
            (
                "Electric Sitar",
                (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS),
            ),
            ...
            ("Epinette Des Vosges", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Equipment", (Category.TECHNICAL,)),
            ("Field Recording", (Category.TECHNICAL,)),
            ("Filmed By", (Category.TECHNICAL,)),
            ("Flute d'Amour", (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS)),
            ("Footage By", (Category.TECHNICAL,)),
            ("Fretless Bass", (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS)),
            (
                "Fretless Guitar",
                (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS),
            ),
            ("Frottoir", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Fujara", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Gaita", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Galoubet", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Garklein Recorder", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Giga", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Gittern", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Gong Chime", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Gralla", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Graphic Design", (Category.VISUAL,)),
            ("Guacharaca", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Güira", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Guitar Banjo", (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS)),
            ("Guitaret", (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS)),
            ("Haegum", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Hair", (Category.VISUAL,)),
            (
                "Hammered Dulcimer",
                (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS),
            ),
            ("Handbell", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Hang Drum", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Hichiriki", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Highland Pipes", (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS)),
            ("Hosho", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Hulusi", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Ichigenkin", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Image Editor", (Category.VISUAL,)),
            ("Instrument Builder", (Category.TECHNICAL,)),
            (
                "Irish Bouzouki",
                (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS),
            ),
            ("Irish Flute", (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS)),
            ("Jaggo", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Jing", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Ka", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Kagura Suzu", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Kanklės", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Kannel", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Kokle", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Kortholt", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Krar", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Lagerphone", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Lamellophone", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Langeleik", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Laouto", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Lathe Cut By", (Category.TECHNICAL,)),
            ("Lavta", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Lettering", (Category.VISUAL,)),
            ("Limbe", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Lira", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Lira Da Braccio", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Lirone", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Lithography", (Category.VISUAL,)),
            ("Logo", (Category.VISUAL,)),
            ("Lute Guitar", (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS)),
            ("Luthier", (Category.TECHNICAL,)),
            ("Lyra Viol", (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS)),
            ("Lyrics", (Category.WRITING_AND_ARRANGEMENT,)),
            ("Madal", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Make-Up", (Category.VISUAL,)),
            ("Mallets", (Category.INSTRUMENTS, Subcategory.TUNED_PERCUSSION)),
            ("Mandobass", (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS)),
            (
                "Mandolin Banjo",
                (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS),
            ),
            ("Mänkeri", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Marxophone", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Masinko", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Mastered", (Category.TECHNICAL,)),
            ("Mey", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Mixed", (Category.TECHNICAL,)),
            ("Model", (Category.VISUAL,)),
            ("Mohan Veena", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            (
                "Mountain Dulcimer",
                (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS),
            ),
            ("Mouth Organ", (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS)),
            ("Musical Bow", (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS)),
            ("Music Director", (Category.PRODUCTION,)),
            ("Ngoni", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            (
                "Northumbrian Pipes",
                (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS),
            ),
            ("Oboe Da Caccia", (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS)),
            (
                "Open-Back Banjo",
                (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS),
            ),
            ("Overdubbed By", (Category.TECHNICAL,)),
            ("Overtone Flute", (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS)),
            ("Pakhavaj", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Panduri", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Piccolo Banjo", (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS)),
            (
                "Piccolo Bass Guitar",
                (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS),
            ),
            ("Piccolo Trumpet", (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS)),
            ("Piri", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Plated By", (Category.TECHNICAL,)),
            (
                "Plectrum Banjo",
                (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS),
            ),
            ("Positive Organ", (Category.INSTRUMENTS, Subcategory.KEYBOARD)),
            ("Post Production", (Category.PRODUCTION,)),
            ("Prempensua", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Programmed", (Category.TECHNICAL,)),
            ("Project Manager", (Category.PRODUCTION,)),
            ("Promotion", (Category.PRODUCTION,)),
            ("Proofreader", (Category.VISUAL,)),
            ("Public Relations", (Category.PRODUCTION,)),
            ("Pump Organ", (Category.INSTRUMENTS, Subcategory.KEYBOARD)),
            ("Quijada", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Rabeca", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Rackett", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Recorded", (Category.TECHNICAL,)),
            ("Remastered", (Category.TECHNICAL,)),
            (
                "Resonator Banjo",
                (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS),
            ),
            ("Restoration", (Category.TECHNICAL,)),
            ("Rhythm Section", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Ronroco", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Saenghwang", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Sanshin", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Santur", (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS)),
            ("Satsuma", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Saxhorn", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Sazbus", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Schwyzerörgeli", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Screen Printing", (Category.TECHNICAL,)),
            (
                "Selmer-Maccaferri Guitar",
                (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS),
            ),
            ("Sequencer", (Category.TECHNICAL,)),
            ("Setar", (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS)),
            ("Shakubyoshi", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Shofar", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Shruti Box", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Shuitar", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Smallpipes", (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS)),
            ("Software Instrument", (Category.TECHNICAL,)),
            (
                "Sopranino Recorder",
                (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS),
            ),
            ("Soprano Cornet", (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS)),
            ("Soprano Flute", (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS)),
            ("Soprano Recorder", (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS)),
            ("Steirische Harmonika", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Stomp Box", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("String Drum", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Stylist", (Category.VISUAL,)),
            ("Taepyungso", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Taishōgoto", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Talharpa", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Tamboril", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Tangent Piano", (Category.INSTRUMENTS, Subcategory.KEYBOARD)),
            ("Tannerin", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Taonga Pūoro", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Tarka", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Tenor Banjo", (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS)),
            ("Tenor Flute", (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS)),
            ("Tenor Guitar", (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS)),
            ("Tenor Horn", (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS)),
            ("Tenor Recorder", (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS)),
            ("Tenor Trombone", (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS)),
            ("Tenor Viol", (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS)),
            ("Tenor Vocal", (Category.VOCAL,)),
            ("Thavil", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Timple", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Tingsha", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Tonette", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Tour Manager", (Category.PRODUCTION,)),
            ("Tovshuur", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Translated", (Category.TECHNICAL,)),
            ("Traverso", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Treble Viol", (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS)),
            ("Tromba Marina", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Trutruka", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Tsuur", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Tubular Bells", (Category.INSTRUMENTS, Subcategory.TUNED_PERCUSSION)),
            ("Tumbi", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Tuner", (Category.TECHNICAL,)),
            ("Txalaparta", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Txistu", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Tzouras", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Uilleann Pipes", (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS)),
            ("Ukulele Banjo", (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS)),
            ("Ütőgardon", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Viola Caipira", (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS)),
            (
                "Viola Da Gamba",
                (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS),
            ),
            ...
            ("Viola Kontra", (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS)),
            (
                "Viola Nordestina",
                (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS),
            ),
            ...
            ("Violoncello", (Category.INSTRUMENTS, Subcategory.STRINGED_INSTRUMENTS)),
            ("Vocal Coach", (Category.TECHNICAL,)),
            ("Vocal Percussion", (Category.VOCAL,)),
            ("Wagner Tuba", (Category.INSTRUMENTS, Subcategory.WIND_INSTRUMENTS)),
            ("Washtub Bass", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Xiao", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Yanggeum", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
            ("Zabumba", (Category.INSTRUMENTS, Subcategory.OTHER_MUSICAL)),
