"""
This module provides data access functionality for releases within the Discograph offline system.
...
The `Release` class from `discograph.offline.domain` is used to represent releases.
`EntityDetailsIndex` from `discograph.library.full_text_search` is used to manage
the index.
"""
...
class ReleaseDataAccess:
    """
    Provides data access functionality for releases within the Discograph offline system.
