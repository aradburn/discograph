...
managing, and processing release data in the Discograph offline system.
...
from discograph.offline.loader.worker_release_deleter import WorkerReleaseDeleter
from discograph.offline.loader.worker_release_inserter import WorkerReleaseInserter
from discograph.offline.loader.worker_release_pass_two import WorkerReleasePassTwo
from discograph.offline.loader.worker_release_updater import WorkerReleaseUpdater
...
class LoaderRelease(LoaderBase):
    """
    Manages loading, handling, and processing release data in the Discograph offline system.
    ...
    def loader_release_vacuum(
        ...
        """
        Performs database cleanup on the release table.

        This method executes the `VACUUM` command on the `ReleaseRepository`,
        which can help to defragment and optimize the database.
