...
responsible for updating or inserting entity records in the Discograph offline
database.
...
interacts with `discograph.offline.database` for database related operations,
`discograph.library.full_text_search` for text normalization and
`discograph.offline.offline_database_manager` for managing concurrency.
"""
