"""
This module defines the base class for XML parsers in the Discograph offline system.
...
logging operations, `typing` for type hinting, and `discograph.offline.loader.loader_utils`
for loader-specific utilities. `discograph.offline.loader.parser_utils` is used
