"""
This module defines the domain objects for handling metadata within the Discograph system.
...
class _MetadataBase(InternalDomainObject):
    ...
    in the Discograph system. It provides a structure for metadata entries
