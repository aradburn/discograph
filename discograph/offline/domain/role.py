"""
This module defines the domain objects for representing roles within the Discograph system.
...
class _RoleBase(InternalDomainObject):
    ...
    in the Discograph system. It provides a structure for roles with a name,
