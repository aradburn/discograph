...
access methods for roles in the Discograph runtime system.
...
hinting and interacts with `discograph` library for specific cache and type.
"""
...
class RuntimeRoleDataAccess:
    """
    Provides data access methods for roles in the Discograph runtime system.
