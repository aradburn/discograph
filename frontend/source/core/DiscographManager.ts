...
/**
 * Core Discograph configuration
 */
export interface DiscographConfig {
    /** Debug mode flag */
    debug?: boolean;
    /** Version information */
    version?: string;
...
export class DiscographManager {
    ...
    /**
     * Creates a new DiscographManager instance
     * @param {DiscographConfig} config - Configuration options
     */
    constructor(config: DiscographConfig = {}) {
...
export const discographManager = new DiscographManager();
