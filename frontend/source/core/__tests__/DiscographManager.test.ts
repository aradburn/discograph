...
import {
    DiscographManager,
    discographManager,
    type DiscographConfig,
} from "../DiscographManager";
...
describe("DiscographManager", () => {
    ...
    describe("constructor", () => {
        it("should initialize with default values when no config is provided", () => {
            const manager = new DiscographManager();
        ...
        it("should initialize with custom config values", () => {
            const config: DiscographConfig = {
                version: "3.0.0",
                debug: true,
                dpr: 2,
            };
            const manager = new DiscographManager(config);
    ...
    describe("getters and setters", () => {
        let manager: DiscographManager;

        beforeEach(() => {
            manager = new DiscographManager();
        });
    ...
    describe("methods", () => {
        ...
        beforeEach(() => {
            manager = new DiscographManager({ dpr: 2 });
        });
    ...
    describe("singleton instance", () => {
        it("should export a singleton instance", () => {
            expect(discographManager).toBeInstanceOf(DiscographManager);
        });
        ...
        it("should be the same instance when imported multiple times", () => {
            ...
            expect(discographManager).toBe(discographManager);
        });
    });
});
