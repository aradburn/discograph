...
import { relationsManager, discographManager } from "../core";
...
vi.mock("../core", () => {
    ...
    const mockRelationsManager = {
        ...
        // Add reference to discographManager
        get discographManager() {
            return mockDiscographManager;
        },
        setData: vi.fn((data) => {
    ...
    return {
        discographManager: mockDiscographManager,
        ...
        it("should handle errors when creating radial chart with invalid dimensions", () => {
            ...
            try {
                ...
                vi.spyOn(
                    ...
                    discographManager.dimensions = null as unknown as [
                        number,
                        number,
                    ];
                ...
                discographManager.dimensions = [800, 600] as [number, number];
            }
        });
    });
        ...
        it("should calculate barHeight correctly from dimensions", () => {
            ...
            vi.spyOn(relationsModule, "createRadialChart").mockImplementation(
                () => {
                    ...
                    const barHeight =
                        Math.min(
                            ...(discographManager.dimensions || [800, 600]),
                        ) / RELATIONS.DIMENSIONS.DIVISOR;
            ...
            discographManager.dimensions = mockDimensions;
            createRadialChart();
            expect(consoleSpy).toHaveBeenCalledWith(
            ...
            discographManager.dimensions = [500, 500] as [number, number];
            createRadialChart();
            expect(consoleSpy).toHaveBeenCalledWith(
                "createRadialChart() barHeight:",
            ...
            discographManager.dimensions = [100, 200] as [number, number];
            createRadialChart();
            expect(consoleSpy).toHaveBeenCalledWith(
                "createRadialChart() barHeight:",
        ...
        it("should test transform function with different angle configurations", () => {
            ...
            const testTransform = vi
                ...
                .mockImplementation(() => {
                    ...
                    discographManager.dimensions = [800, 600] as [
                        number,
                        number,
                    ];
