...
export const FSM = {
    ...
    EVENTS: {
        REQUEST_NETWORK: "discograph:request-network",
        REQUEST_RANDOM: "discograph:request-random",
        SELECT_ENTITY: "discograph:select-entity",
        SHOW_NETWORK: "discograph:show-network",
        SHOW_RADIAL: "discograph:show-radial",
        RESIZE: "discograph:resize",
    },
};
