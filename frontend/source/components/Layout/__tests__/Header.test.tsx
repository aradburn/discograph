...
describe("Header Component", () => {
    ...
    it("renders correctly with all elements", () => {
        ...
        // Check brand section
        expect(screen.getByText("DISCOGRAPH")).toBeInTheDocument();
    ...
    it("calls onShowWho callback when brand is clicked", async () => {
        ...
        // we'll simulate a direct click on a div that contains "DISCOGRAPH"
        const brandText = screen.getByText("DISCOGRAPH");
    ...
    it("renders tooltips correctly", () => {
        ...
        expect(tooltipTexts).toContain("Discograph");
