    ...
    return (
        <Modal show={show} onHide={handleClose}>
            ...
            <Modal.Body>
                ...
                <p>
                    <strong>Discograph</strong> is made with a little help from
                ...
                <p>
                    <strong>Discograph</strong> would also be impossible without
                ...
                <p>
                    You can fork <strong>Discograph</strong> on{" "}
                    <a
