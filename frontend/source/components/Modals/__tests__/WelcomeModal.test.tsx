...
describe("WelcomeModal Component", () => {
    ...
    it("should render correctly when show is true", () => {
        ...
        // Use getAllByText since "Discograph" appears multiple times
        const discographElements = screen.getAllByText(/Discograph/i);
        expect(discographElements.length).toBeGreaterThan(0);
