...
interface NetworkLayers {
  link?: d3.Selection<SVGGElement, NetworkLink, HTMLElement, unknown>;
  halo?: d3.Selection<SVGGElement, PositionedNode[], HTMLElement, unknown>;
  node?: d3.Selection<SVGGElement, PositionedNode, HTMLElement, unknown>;
  text?: d3.Selection<SVGGElement, PositionedNode, HTMLElement, unknown>;
}
 ...
 */
export const onTick = (e: d3.Simulation<PositionedNode, undefined>): void => {
  dg.network.tick += 1;
