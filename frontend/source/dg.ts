...
import type { SimNode } from "./network/forceLayout";
import type { NetworkNode, NetworkLink } from "./network/node";
...
interface NetworkSelections {
  halo: Selection<SVGGElement, NetworkNode, SVGGElement, unknown> | null;
  hull: Selection<SVGGElement, NetworkNode[], SVGGElement, unknown> | null;
  node: Selection<SVGGElement, NetworkNode, SVGGElement, unknown> | null;
  link: Selection<SVGGElement, NetworkLink, SVGGElement, unknown> | null;
  text: Selection<SVGGElement, NetworkNode, SVGGElement, unknown> | null;
}
...
interface Network {
  ...
  forceLayout: Simulation<SimNode, NetworkLink> | null;
