...
describe("WindowContext", () => {
    ...
    it("updates discographManager with dimensions", () => {
        render(
            <WindowProvider>
                <div>Test</div>
            </WindowProvider>,
        ...
        expect(discographManager.dimensions).toEqual([1024, 768]);
        expect(discographManager.svgDimensions).toEqual([
            1024 * SVG.VIEWPORT_SIZE_MULTIPLIER * 2,
            768 * SVG.VIEWPORT_SIZE_MULTIPLIER * 2,
        ]);
    });
