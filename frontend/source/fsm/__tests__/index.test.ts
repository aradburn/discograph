...
// Create a mock implementation of DiscographFSM
...
// Mock the DiscographFSM class
vi.mock("../DiscographFSM", () => ({
...
describe("FSM Module", () => {
    ...
    it("should create a DiscographFSM when initFSM is called", () => {
        // Call initFSM
        fsmModule.initFSM();

        // Check that DiscographFSM constructor was called
        expect(mockDiscographFSM).toHaveBeenCalledTimes(1);
    });
